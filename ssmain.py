...
with col2:
    st.plotly_chart(figpie1, height=600, theme="streamlit",use_container_width=True)
    st.plotly_chart(figpie2, height=600, theme="streamlit",use_container_width=True)
